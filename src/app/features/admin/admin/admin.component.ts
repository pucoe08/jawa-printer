...
export class AdminComponent implements OnInit {
  ...
  totalItems = 0;
  statusOptions = ['All', 'PaymentReceived', 'PaymentMismtach', 'Refunded', 'Pending']
    ...
    this.adminService.refundOrder(id).subscribe({
      next: order => {
        this.dataSource.data =
          this.dataSource.data.map(o => o.id === id ? order : o)
        //this.loadOrders();   easy solution but extra api call
      }
    })
